...
for i in `seq 1 23`;do
  c="`sed ""$i"q;d" /home/pi/lanced/ZVL-Dev/lanced_handler/dep.list`"
...
for i in `seq 21 23`; do
	a="`sed ""$i"q;d" /home/pi/lanced/ZVL-Dev/lanced_handler/dep.list`"
	sed ""$i"q;d" /home/pi/lanced/ZVL-Dev/lanced_handler/dep.list | xargs apt-get -y > /dev/null 2>&1 && eval "v${i}=${GREEN}[${a}]${RESET}" ||
	echo -e "$a" >> /home/pi/lanced/ZVL-Dev/lanced_handler/error.list
  ledger
done

###using the dep.list this iteration hadnles the apt-get install
echo -e "update - upgrade - dist-upgrade DONE" >> /home/pi/lanced/ZVL-Dev/lanced_handler/progress.list

for i in `seq 1 19`; do
 	a="`sed ""$i"q;d" /home/pi/lanced/ZVL-Dev/lanced_handler/dep.list`"
 	sed ""$i"q;d" /home/pi/lanced/ZVL-Dev/lanced_handler/dep.list | xargs apt-get install -y > /dev/null 2>&1 && eval "v${i}=${GREEN}[${a}]${RESET}" ||
 	echo -e "$a" >> /home/pi/lanced/ZVL-Dev/lanced_handler/error.list
  ledger
done

#echo -e "essential files DONE" >> /home/pi/lanced/ZVL-Dev/lanced_handler/progress.list
...
#echo -e "kismet DONE" >> /home/pi/lanced/ZVL-Dev/lanced_handler/progress.list

####SECOND SECTION####

##git folder
#/home/pi/lanced/ZVL-Dev/lanced_handler/
#/etc/kismet/
...
sudo cp /home/pi/lanced/ZVL-Dev/config_files/suidins/{kismet.conf,oui2.txt,correct_date.py} /usr/local/etc/
...
#echo -e "/etc/kismet/ files done" >> /home/pi/lanced/ZVL-Dev/lanced_handler/progress.list
...
sudo cp /home/pi/lanced/ZVL-Dev/config_files/{gpsd,hostapd} /etc/default/
#sudo chmod 777 /etc/default/gpsd
#sudo chmod 777 /etc/default/hostapd

#echo -e "gpsd - hostapd files done" >> /home/pi/lanced/ZVL-Dev/lanced_handler/progress.list

#/etc/network/interfaces
sudo mv /etc/network/interfaces /etc/network/interfaces.origin
sudo cp /home/pi/lanced/ZVL-Dev/config_files/interfaces /etc/network/

#echo -e "interfaces done" >> /home/pi/lanced/ZVL-Dev/lanced_handler/progress.list
...
sudo cp /home/pi/lanced/ZVL-Dev/config_files/hostapd.conf /etc/hostapd/

#echo -e "hostapd.conf done" >> /home/pi/lanced/ZVL-Dev/lanced_handler/progress.list
...
sudo cp /home/pi/lanced/ZVL-Dev/config_files/rc.local /etc/
...
sudo mv /home/pi/lanced/ZVL-Dev/lanced_handler/asuidroot.sh /home/pi/asuidroot.sh
...
#echo -e "/etc/ done" >> /home/pi/lanced/ZVL-Dev/lanced_handler/progress.list

#echo -e "FINALIZED" >> /home/pi/lanced/ZVL-Dev/lanced_handler/progress.list
